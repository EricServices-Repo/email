...
$ROUNDCUBEHASH=openssl rand -base64 12
...
cat << EOF >> /var/www/html/mail/config/config.inc.php
<?php
...
$config['db_dsnw'] = 'mysql://roundcube:$PFAPASSWORD@localhost/roundcubemail';
...
$config['des_key'] = '$ROUNDCUBEHASH';

// Name your service. This is displayed on the login screen and in the window title
$config['product_name'] = '$DOMAIN Email';
